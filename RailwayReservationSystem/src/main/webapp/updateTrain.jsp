        ...
        xhr.onreadystatechange = function () {
            if (xhr.readyState === 4) {
                if (xhr.status === 200) {
                    ...
                    alert("Error fetching train details. Server returned status " + xhr.status);
                }
            }
        };
...
.update-train-container button:hover {
...
<div class="upper-container">
    	<div class="update-train-container">
        		<h1>Update Train</h1>
